...
const char *RConfigAqaraS1StandbyEnabled = "config/aqara_s1_standby_enabled";
const char *RConfigAqaraS1ScreenSaverStyle = "config/aqara_s1_screen_saver_style";
const char *RConfigAqaraS1Theme = "config/aqara_s1_theme";
const char *RConfigAqaraS1StandbyTime = "config/aqara_s1_standby_time";
const char *RConfigAqaraS1FontSize = "config/aqara_s1_font_size";
const char *RConfigAqaraS1LCDAutoBrightnessEnabled = "config/aqara_s1_lcd_auto_brightness_enabled";
const char *RConfigAqaraS1Homepage = "config/aqara_s1_homepage";
const char *RConfigAqaraS1ScreenSaverEnabled = "config/aqara_s1_screen_saver_enabled";
const char *RConfigAqaraS1StandbyLCDBrightness = "config/aqara_s1_standby_lcd_brightness";
const char *RConfigAqaraS1Switch1Icon = "config/aqara_s1_switch1_icon";
const char *RConfigAqaraS1Switch1Text = "config/aqara_s1_switch1_text";
const char *RConfigAqaraS1Switch2Icon = "config/aqara_s1_switch2_icon";
const char *RConfigAqaraS1Switch2Text = "config/aqara_s1_switch2_text";
const char *RConfigAqaraS1Switch3Icon = "config/aqara_s1_switch3_icon";
const char *RConfigAqaraS1Switch3Text = "config/aqara_s1_switch3_text";
const char *RConfigAqaraS1AutoUpdateFWEnabled = "config/aqara_s1_auto_update_fw_enabled";
const char *RConfigAqaraS1SwitchesConfig = "config/aqara_s1_switches_config";
const char *RConfigAqaraS1Gestures = "config/aqara_s1_gestures";
...
void initResourceDescriptors()
{
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, QVariant::Bool, RConfigAqaraS1StandbyEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigAqaraS1ScreenSaverStyle));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigAqaraS1Theme));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt32, QVariant::Double, RConfigAqaraS1StandbyTime));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigAqaraS1FontSize));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, QVariant::Bool, RConfigAqaraS1LCDAutoBrightnessEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigAqaraS1Homepage));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, QVariant::Bool, RConfigAqaraS1ScreenSaverEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigAqaraS1StandbyLCDBrightness));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigAqaraS1Switch1Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, QVariant::String, RConfigAqaraS1Switch1Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigAqaraS1Switch2Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, QVariant::String, RConfigAqaraS1Switch2Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigAqaraS1Switch3Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, QVariant::String, RConfigAqaraS1Switch3Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, QVariant::Bool, RConfigAqaraS1AutoUpdateFWEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigAqaraS1SwitchesConfig));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigAqaraS1Gestures));
