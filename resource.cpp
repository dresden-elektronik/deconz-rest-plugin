...
void initResourceDescriptors()
{
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, RStateAqaraS1PanelCommunication));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1Language));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1LCDBrightness));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1SoundVolume));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, RStateAqaraS1StandbyEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1ScreenSaverStyle));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1Theme));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt32, RStateAqaraS1StandbyTime));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1FontSize));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, RStateAqaraS1LCDAutoBrightnessEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1Homepage));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, RStateAqaraS1ScreenSaverEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1StandbyLCDBrightness));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1Switch1Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, RStateAqaraS1Switch1Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1Switch2Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, RStateAqaraS1Switch2Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1Switch3Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, RStateAqaraS1Switch3Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, RStateAqaraS1AutoUpdateFWEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1SwitchesConfig));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1Gestures));
