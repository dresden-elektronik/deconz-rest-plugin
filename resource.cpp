...
const char *RConfigFontSize = "config/font_size";
const char *RConfigGesturesEnabled = "config/gestures_enabled";
...
const char *RConfigHomepage = "config/homepage";
...
const char *RConfigScreenSaverEnabled = "config/screen_saver_enabled";
const char *RConfigScreenSaverStyle = "config/screen_saver_style";
...
const char *RConfigSoundVolume = "config/sound_volume";
const char *RConfigSpeed = "config/speed";
const char *RConfigStandbyEnabled = "config/standby_enabled";
const char *RConfigStandbyLCDBrightness = "config/standby_lcd_brightness";
const char *RConfigStandbyTime = "config/standby_time";
...
const char *RConfigSwitch1Icon = "config/switch1_icon";
const char *RConfigSwitch1Text = "config/switch1_text";
const char *RConfigSwitch2Icon = "config/switch2_icon";
const char *RConfigSwitch2Text = "config/switch2_text";
const char *RConfigSwitch3Icon = "config/switch3_icon";
const char *RConfigSwitch3Text = "config/switch3_text";
const char *RConfigSwitchesConfig = "config/switches_config";
...
const char *RConfigTheme = "config/theme";
...
void initResourceDescriptors()
{
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigFontSize));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigGesturesEnabled));
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigHomepage));
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigLanguage));
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, QVariant::Bool, RConfigScreenSaverEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigScreenSaverStyle));
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigSoundVolume));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeInt8, QVariant::Double, RConfigSpeed));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, QVariant::Bool, RConfigStandbyEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigStandbyLCDBrightness));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt32, QVariant::Double, RConfigStandbyTime));
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigSwitch1Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, QVariant::String, RConfigSwitch1Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigSwitch2Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, QVariant::String, RConfigSwitch2Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigSwitch3Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, QVariant::String, RConfigSwitch3Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigSwitchesConfig));
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RConfigTheme));
