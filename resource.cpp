...
const char *RStateAqaraS1SoundVolume = "state/aqara_s1_sound_volume";
const char *RStateAqaraS1StandbyEnabled = "state/aqara_s1_standby_enabled";
const char *RStateAqaraS1ScreenSaverStyle = "state/aqara_s1_screen_saver_style";
const char *RStateAqaraS1Theme = "state/aqara_s1_theme";
const char *RStateAqaraS1StandbyTime = "state/aqara_s1_standby_time";
const char *RStateAqaraS1FontSize = "state/aqara_s1_font_size";
const char *RStateAqaraS1LCDAutoBrightnessEnabled = "state/aqara_s1_lcd_auto_brightness_enabled";
const char *RStateAqaraS1Homepage = "state/aqara_s1_homepage";
const char *RStateAqaraS1ScreenSaverEnabled = "state/aqara_s1_screen_saver_enabled";
const char *RStateAqaraS1StandbyLCDBrightness = "state/aqara_s1_standby_lcd_brightness";
const char *RStateAqaraS1Switch1Icon = "state/aqara_s1_switch1_icon";
const char *RStateAqaraS1Switch1Text = "state/aqara_s1_switch1_text";
const char *RStateAqaraS1Switch2Icon = "state/aqara_s1_switch2_icon";
const char *RStateAqaraS1Switch2Text = "state/aqara_s1_switch2_text";
const char *RStateAqaraS1Switch3Icon = "state/aqara_s1_switch3_icon";
const char *RStateAqaraS1Switch3Text = "state/aqara_s1_switch3_text";
const char *RStateAqaraS1AutoUpdateFWEnabled = "state/aqara_s1_auto_update_fw_enabled";
const char *RStateAqaraS1SwitchesConfig = "state/aqara_s1_switches_config";
const char *RStateAqaraS1Gestures = "state/aqara_s1_gestures";
...
void initResourceDescriptors()
{
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStateAqaraS1SoundVolume));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, QVariant::Bool, RStateAqaraS1StandbyEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStateAqaraS1ScreenSaverStyle));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStateAqaraS1Theme));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt32, QVariant::Double, RStateAqaraS1StandbyTime));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStateAqaraS1FontSize));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, QVariant::Bool, RStateAqaraS1LCDAutoBrightnessEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStateAqaraS1Homepage));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, QVariant::Bool, RStateAqaraS1ScreenSaverEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStateAqaraS1StandbyLCDBrightness));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStateAqaraS1Switch1Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, QVariant::String, RStateAqaraS1Switch1Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStateAqaraS1Switch2Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, QVariant::String, RStateAqaraS1Switch2Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStateAqaraS1Switch3Icon));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeString, QVariant::String, RStateAqaraS1Switch3Text));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, QVariant::Bool, RStateAqaraS1AutoUpdateFWEnabled));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStateAqaraS1SwitchesConfig));
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, QVariant::Double, RStateAqaraS1Gestures));
