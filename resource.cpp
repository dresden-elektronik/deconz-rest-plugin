...
const char *RStateAqaraS1ScreenSaver = "state/aqara_s1_screen_saver";
...
const char *RStateAqaraS1AutoUpdateFW = "state/aqara_s1_auto_update_fw";
...
void initResourceDescriptors()
{
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeInt32, RStateAqaraS1StandbyTime));
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt8, RStateAqaraS1ScreenSaver));
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeBool, RStateAqaraS1AutoUpdateFW));
