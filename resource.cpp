...
const char *RAttrOtauImageType = "attr/otau/imagetype";
const char *RAttrOtauManufacturerCode = "attr/otau/manufacturercode";
const char *RAttrOtauVersion = "attr/otau/version";
...
void initResourceDescriptors()
{
    ...
    rItemDescriptors.emplace_back(ResourceItemDescriptor(DataTypeUInt32, QVariant::Double, RAttrOtauVersion));
