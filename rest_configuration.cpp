...
//#endif
    ...
    for (; i != end; ++i)
    {
        if (QString(*i).indexOf("ESSID:") != -1)
        {
            ...
            cell["security"] = QString("%1%2%3").arg(security).arg(cipher).arg(key);
