...
//    mode                          ep    cluster cmd   param button                                       name
    ...
    { Sensor::ModeScenes,           0x01, 0x0008, 0x01, 1,    S_BUTTON_2 + S_BUTTON_ACTION_HOLD,           "DimDown" },
    { Sensor::ModeScenes,           0x01, 0x0008, 0x02, 1,    S_BUTTON_2 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown" },
    { Sensor::ModeScenes,           0x01, 0x0008, 0x03, 1,    S_BUTTON_2 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown" },
    { Sensor::ModeScenes,           0x01, 0x0008, 0x01, 0,    S_BUTTON_3 + S_BUTTON_ACTION_HOLD,           "DimUp" },
    { Sensor::ModeScenes,           0x01, 0x0008, 0x02, 0,    S_BUTTON_3 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp" },
    { Sensor::ModeScenes,           0x01, 0x0008, 0x03, 0,    S_BUTTON_3 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp" },
    ...
    // { Sensor::ModeScenes,           0x03, 0x0008, 0x01, 1,         11000 + S_BUTTON_ACTION_HOLD,           "DimDown 1" },
    // { Sensor::ModeScenes,           0x03, 0x0008, 0x02, 1,         11000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 1" },
    // { Sensor::ModeScenes,           0x03, 0x0008, 0x03, 1,         11000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 1" },
    // { Sensor::ModeScenes,           0x03, 0x0008, 0x01, 0,         12000 + S_BUTTON_ACTION_HOLD,           "DimUp 1" },
    // { Sensor::ModeScenes,           0x03, 0x0008, 0x02, 0,         12000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 1" },
    // { Sensor::ModeScenes,           0x03, 0x0008, 0x03, 0,         12000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 1" },
    { Sensor::ModeScenes,           0x03, 0x0006, 0x00, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 1" },
    { Sensor::ModeScenes,           0x03, 0x0006, 0x01, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 1" },
    { Sensor::ModeScenes,           0x03, 0x0008, 0x01, 1,    S_BUTTON_2 + S_BUTTON_ACTION_HOLD,           "DimDown 1" },
    { Sensor::ModeScenes,           0x03, 0x0008, 0x02, 1,    S_BUTTON_2 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 1" },
    { Sensor::ModeScenes,           0x03, 0x0008, 0x03, 1,    S_BUTTON_2 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 1" },
    { Sensor::ModeScenes,           0x03, 0x0008, 0x01, 0,    S_BUTTON_3 + S_BUTTON_ACTION_HOLD,           "DimUp 1" },
    { Sensor::ModeScenes,           0x03, 0x0008, 0x02, 0,    S_BUTTON_3 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 1" },
    { Sensor::ModeScenes,           0x03, 0x0008, 0x03, 0,    S_BUTTON_3 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 1" },
    ...
    // { Sensor::ModeScenes,           0x04, 0x0008, 0x01, 1,         14000 + S_BUTTON_ACTION_HOLD,           "DimDown 2" },
    // { Sensor::ModeScenes,           0x04, 0x0008, 0x02, 1,         14000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 2" },
    // { Sensor::ModeScenes,           0x04, 0x0008, 0x03, 1,         14000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 2" },
    // { Sensor::ModeScenes,           0x04, 0x0008, 0x01, 0,         15000 + S_BUTTON_ACTION_HOLD,           "DimUp 2" },
    // { Sensor::ModeScenes,           0x04, 0x0008, 0x02, 0,         15000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 2" },
    // { Sensor::ModeScenes,           0x04, 0x0008, 0x03, 0,         15000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 2" },
    { Sensor::ModeScenes,           0x04, 0x0006, 0x00, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 2" },
    { Sensor::ModeScenes,           0x04, 0x0006, 0x01, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 2" },
    { Sensor::ModeScenes,           0x04, 0x0008, 0x01, 1,    S_BUTTON_2 + S_BUTTON_ACTION_HOLD,           "DimDown 2" },
    { Sensor::ModeScenes,           0x04, 0x0008, 0x02, 1,    S_BUTTON_2 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 2" },
    { Sensor::ModeScenes,           0x04, 0x0008, 0x03, 1,    S_BUTTON_2 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 2" },
    { Sensor::ModeScenes,           0x04, 0x0008, 0x01, 0,    S_BUTTON_3 + S_BUTTON_ACTION_HOLD,           "DimUp 2" },
    { Sensor::ModeScenes,           0x04, 0x0008, 0x02, 0,    S_BUTTON_3 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 2" },
    { Sensor::ModeScenes,           0x04, 0x0008, 0x03, 0,    S_BUTTON_3 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 2" },
    ...
    // { Sensor::ModeScenes,           0x05, 0x0008, 0x01, 1,         17000 + S_BUTTON_ACTION_HOLD,           "DimDown 3" },
    // { Sensor::ModeScenes,           0x05, 0x0008, 0x02, 1,         17000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 3" },
    // { Sensor::ModeScenes,           0x05, 0x0008, 0x03, 1,         17000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 3" },
    // { Sensor::ModeScenes,           0x05, 0x0008, 0x01, 0,         18000 + S_BUTTON_ACTION_HOLD,           "DimUp 3" },
    // { Sensor::ModeScenes,           0x05, 0x0008, 0x02, 0,         18000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 3" },
    // { Sensor::ModeScenes,           0x05, 0x0008, 0x03, 0,         18000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 3" },
    { Sensor::ModeScenes,           0x05, 0x0006, 0x00, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 3" },
    { Sensor::ModeScenes,           0x05, 0x0006, 0x01, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 3" },
    { Sensor::ModeScenes,           0x05, 0x0008, 0x01, 1,    S_BUTTON_2 + S_BUTTON_ACTION_HOLD,           "DimDown 3" },
    { Sensor::ModeScenes,           0x05, 0x0008, 0x02, 1,    S_BUTTON_2 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 3" },
    { Sensor::ModeScenes,           0x05, 0x0008, 0x03, 1,    S_BUTTON_2 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 3" },
    { Sensor::ModeScenes,           0x05, 0x0008, 0x01, 0,    S_BUTTON_3 + S_BUTTON_ACTION_HOLD,           "DimUp 3" },
    { Sensor::ModeScenes,           0x05, 0x0008, 0x02, 0,    S_BUTTON_3 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 3" },
    { Sensor::ModeScenes,           0x05, 0x0008, 0x03, 0,    S_BUTTON_3 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 3" },
    ...
    // { Sensor::ModeScenes,           0x06, 0x0008, 0x01, 1,         20000 + S_BUTTON_ACTION_HOLD,           "DimDown 4" },
    // { Sensor::ModeScenes,           0x06, 0x0008, 0x02, 1,         20000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 4" },
    // { Sensor::ModeScenes,           0x06, 0x0008, 0x03, 1,         20000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 4" },
    // { Sensor::ModeScenes,           0x06, 0x0008, 0x01, 0,         21000 + S_BUTTON_ACTION_HOLD,           "DimUp 4" },
    // { Sensor::ModeScenes,           0x06, 0x0008, 0x02, 0,         21000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 4" },
    // { Sensor::ModeScenes,           0x06, 0x0008, 0x03, 0,         21000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 4" },
    { Sensor::ModeScenes,           0x06, 0x0006, 0x00, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 4" },
    { Sensor::ModeScenes,           0x06, 0x0006, 0x01, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 4" },
    { Sensor::ModeScenes,           0x06, 0x0008, 0x01, 1,    S_BUTTON_2 + S_BUTTON_ACTION_HOLD,           "DimDown 4" },
    { Sensor::ModeScenes,           0x06, 0x0008, 0x02, 1,    S_BUTTON_2 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 4" },
    { Sensor::ModeScenes,           0x06, 0x0008, 0x03, 1,    S_BUTTON_2 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 4" },
    { Sensor::ModeScenes,           0x06, 0x0008, 0x01, 0,    S_BUTTON_3 + S_BUTTON_ACTION_HOLD,           "DimUp 4" },
    { Sensor::ModeScenes,           0x06, 0x0008, 0x02, 0,    S_BUTTON_3 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 4" },
    { Sensor::ModeScenes,           0x06, 0x0008, 0x03, 0,    S_BUTTON_3 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 4" },
    ...
    // { Sensor::ModeScenes,           0x07, 0x0008, 0x01, 1,         23000 + S_BUTTON_ACTION_HOLD,           "DimDown 5" },
    // { Sensor::ModeScenes,           0x07, 0x0008, 0x02, 1,         23000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 5" },
    // { Sensor::ModeScenes,           0x07, 0x0008, 0x03, 1,         23000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 5" },
    // { Sensor::ModeScenes,           0x07, 0x0008, 0x01, 0,         24000 + S_BUTTON_ACTION_HOLD,           "DimUp 5" },
    // { Sensor::ModeScenes,           0x07, 0x0008, 0x02, 0,         24000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 5" },
    // { Sensor::ModeScenes,           0x07, 0x0008, 0x03, 0,         24000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 5" },
    { Sensor::ModeScenes,           0x07, 0x0006, 0x00, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 5" },
    { Sensor::ModeScenes,           0x07, 0x0006, 0x01, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 5" },
    { Sensor::ModeScenes,           0x07, 0x0008, 0x01, 1,    S_BUTTON_2 + S_BUTTON_ACTION_HOLD,           "DimDown 5" },
    { Sensor::ModeScenes,           0x07, 0x0008, 0x02, 1,    S_BUTTON_2 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 5" },
    { Sensor::ModeScenes,           0x07, 0x0008, 0x03, 1,    S_BUTTON_2 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 5" },
    { Sensor::ModeScenes,           0x07, 0x0008, 0x01, 0,    S_BUTTON_3 + S_BUTTON_ACTION_HOLD,           "DimUp 5" },
    { Sensor::ModeScenes,           0x07, 0x0008, 0x02, 0,    S_BUTTON_3 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 5" },
    { Sensor::ModeScenes,           0x07, 0x0008, 0x03, 0,    S_BUTTON_3 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 5" },
    ...
    // { Sensor::ModeScenes,           0x08, 0x0008, 0x01, 1,         26000 + S_BUTTON_ACTION_HOLD,           "DimDown 6" },
    // { Sensor::ModeScenes,           0x08, 0x0008, 0x02, 1,         26000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 6" },
    // { Sensor::ModeScenes,           0x08, 0x0008, 0x03, 1,         26000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 6" },
    // { Sensor::ModeScenes,           0x08, 0x0008, 0x01, 0,         27000 + S_BUTTON_ACTION_HOLD,           "DimUp 6" },
    // { Sensor::ModeScenes,           0x08, 0x0008, 0x02, 0,         27000 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 6" },
    // { Sensor::ModeScenes,           0x08, 0x0008, 0x03, 0,         27000 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 6" },
    { Sensor::ModeScenes,           0x08, 0x0006, 0x00, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 6" },
    { Sensor::ModeScenes,           0x08, 0x0006, 0x01, 0,    S_BUTTON_1 + S_BUTTON_ACTION_SHORT_RELEASED, "OnOff 6" },
    { Sensor::ModeScenes,           0x08, 0x0008, 0x01, 1,    S_BUTTON_2 + S_BUTTON_ACTION_HOLD,           "DimDown 6" },
    { Sensor::ModeScenes,           0x08, 0x0008, 0x02, 1,    S_BUTTON_2 + S_BUTTON_ACTION_SHORT_RELEASED, "DimDown 6" },
    { Sensor::ModeScenes,           0x08, 0x0008, 0x03, 1,    S_BUTTON_2 + S_BUTTON_ACTION_LONG_RELEASED,  "DimDown 6" },
    { Sensor::ModeScenes,           0x08, 0x0008, 0x01, 0,    S_BUTTON_3 + S_BUTTON_ACTION_HOLD,           "DimUp 6" },
    { Sensor::ModeScenes,           0x08, 0x0008, 0x02, 0,    S_BUTTON_3 + S_BUTTON_ACTION_SHORT_RELEASED, "DimUp 6" },
    { Sensor::ModeScenes,           0x08, 0x0008, 0x03, 0,    S_BUTTON_3 + S_BUTTON_ACTION_LONG_RELEASED,  "DimUp 6" },
