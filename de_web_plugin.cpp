            ...
            else if (ic->id() == BASIC_CLUSTER_ID && (event.clusterId() == BASIC_CLUSTER_ID))
            {
                ...
                for (;ia != enda; ++ia)
                {
                    ...
                    if (ia->id() == 0x0004) // Manufacturer name
                    {
                        ...
                        ResourceItem *item = lightNode->item(RAttrManufacturerName);
                        if (item && !str.isEmpty() && str != lightNode->manufacturer())
                        {
                            if (str == QString("欧瑞博"))
                            {
                    ...
                    else if (event.clusterId() == BASIC_CLUSTER_ID)
                    {
                        ...
                        for (;ia != enda; ++ia)
                        {
                            ...
                            if (ia->id() == 0x0005) // Model identifier
                            {
                                ...
                                ResourceItem *item = i->item(RAttrModelId);
                                if (item && !str.isEmpty())
                                {
                                    if (i->modelId() != str)
                                    {
                            ...
                            else if (ia->id() == 0x0004) // Manufacturer Name
                            {
                                ...
                                QString str = ia->toString().simplified();
                                ResourceItem *item = i->item(RAttrManufacturerName);
